            ...
            <div className="container px-5 py-24 mx-auto">
              <div className="xl:w-1/2 lg:w-3/4 w-full mx-auto text-center">
                ...
                <p className="leading-relaxed text-lg">
                  ...
                  functional websites. I am currently working on a project that
                  allows users to send and receive money globally. It focuses on
                  the user experience and the ease of use and also provides a
                  secure and reliable platform for users to send and receive money.
                </p>
